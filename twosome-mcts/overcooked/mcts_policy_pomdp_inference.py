...
from mcts_policy_pomdp import LLMAgent, LanguageNode
...
if __name__ == "__main__":
    ...
    # 建立 MCTS 树根节点
    root = LanguageNode(state=next_obs, initial_value=1, task=args.env_id, value_weight=args.value_weight)
    ...
    for path_num in range(0, args.path_num):
        ...
        while not done and step < args.depth:
            ...
            if not done and next_node.is_leaf():
                ...
                agent.expand(next_obs, next_node, envs)
