...
os.environ["CUDA_VISIBLE_DEVICES"] = "0"  # 这里的 "0" 是你希望使用的 GPU 设备
...
if __name__ == "__main__":
    ...
    if args.resume:
        ...
        agent = LLMAgent(normalization_mode=args.normalization_mode, load_8bit=args.load_8bit, task=args.task, device=device, llm_base_model=args.llm_base_model, llm_base_model_path=args.llm_base_model_path)
