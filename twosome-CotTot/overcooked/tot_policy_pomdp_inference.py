...
from tot_policy_pomdp import LLMAgent, LanguageNode


def parse_args():
    # fmt: off
    parser = argparse.ArgumentParser()
    parser.add_argument("--expanded-num", type=int, default=2,
        help="the naum of expanded nodes")
...
if __name__ == "__main__":
    ...
    for path_num in range(0, args.path_num):
        ...
        # MC update
        print(f"global_step={global_step}, num_path = {path_num}, episodic_return={done}, episodic_length={step}")
        writer.add_scalar("charts/episodic_return", done, global_step)
