...
if __name__ == '__main__':
    ...
    envs = gym.vector.SyncVectorEnv(
        [make_env(args.env_id, args.seed + i, i, False, run_name, env_params) for i in
         range(1)]
    )
    assert isinstance(envs.single_action_space, gym.spaces.Discrete), "only discrete action space is supported"
    # print(f"@@@@envs.siingle_observation_space:{envs.single_observation_space}")
    # print(f"@@@@envs.single_action_space:{envs.single_action_space}")
    # input()
